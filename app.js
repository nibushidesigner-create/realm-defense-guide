...
const uiText = {
  en: {
    ...
    fanDisclaimer: "Unofficial fan guide. Realm Defense and related assets belong to their respective owners; this site is not affiliated with or endorsed by the game publisher.",
  ...
  zh: {
    ...
    sourceMaps: "地图图片",
    sourceVersions: "版本记录",
    fanDisclaimer: "非官方玩家攻略站。Realm Defense 及相关素材归其各自权利方所有；本站与游戏发行方没有从属、赞助或背书关系。",
